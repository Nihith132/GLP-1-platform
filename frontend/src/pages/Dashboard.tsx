    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <button
          ...
          className="p-4 rounded-lg bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 border border-blue-200 dark:border-blue-800 hover:shadow-md transition-all text-left group"
        >
          ...
          <div className="text-sm text-blue-700 dark:text-blue-300">
            Analyze a single drug label in detail
          </div>
        </button>
        ...
        <button
          ...
          className="p-4 rounded-lg bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950 dark:to-purple-900 border border-purple-200 dark:border-purple-800 hover:shadow-md transition-all text-left group"
        >
          <div className="flex items-center gap-2 text-purple-600 dark:text-purple-400 mb-2">
            <GitCompare className="h-5 w-5" />
            <span className="font-semibold">New Comparison</span>
          </div>
          <div className="text-sm text-purple-700 dark:text-purple-300">
            Compare multiple drug labels side-by-side
          </div>
        </button>
        
        <button
          onClick={() => navigate('/reports')}
          className="p-4 rounded-lg bg-gradient-to-br from-green-50 to-green-100 dark:from-green-950 dark:to-green-900 border border-green-200 dark:border-green-800 hover:shadow-md transition-all text-left group"
        >
          ...
          <div className="text-sm text-green-700 dark:text-green-300">
            Access your saved analysis reports
          </div>
        </button>
      </div>
